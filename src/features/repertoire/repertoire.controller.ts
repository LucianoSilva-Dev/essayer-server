import { Body, Controller, Delete, Get, Param, Patch, Post, Put, Query, Req, Session, UsePipes } from "@nestjs/common";
...
export class RepertoireController {
  ...
  getByIds(
    @Query() query: GetRepertoireByIdsQueryDto,
    @Session() session: UserSession,
  ) {
    const userId = session?.user?.id;
  ...
  createComment(@Param('id') id: string, @Body() data: CreateCommentDto, @Session() session: UserSession) {
  ...
  updateComment(@Param('id') id: string, @Body() data: UpdateCommentDto, @Session() session: UserSession) {
  ...
  fixComment(@Param('id') repertoireId: string, @Param('commentId') commentId: string, @Body() data: FixCommentDto, @Session() session: UserSession) {
