...
export const getAllRepertoireQuerySchema = z.object({
  reperoireType: z.union([z.array(z.enum(RepertoireType)), z.enum(RepertoireType)]).optional(),

  content: z.string().min(1, "field 'content' cannot be empty").optional(),
  ...
  topics: z
    .union([z.string(), z.array(z.string()).min(1, 'The topics field needs at least 1 topic')])
    .transform((val) => (Array.isArray(val) ? val : [val]))
    .optional(),

  creator: z.string().optional(),

  favourited: z.preprocess((val) => {
