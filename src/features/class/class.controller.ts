...
import {
  ...
  GetClassResponseDto,
  GetCreatedClassesResponseDto,
  GetInviteCodeResponseDto,
  GetStudentsResponseDto,
  GetPendingStudentsResponseDto,
  RegenerateCodeResponseDto,
  GetActivitiesResponseDto,
  GetCreatorActivitiesResponseDto,
  GetAllFeedbacksResponseDto,
...
export class ClassController {
  ...
  getAllActivities(
    ...
    @Query() query: GetAllActivitiesQueryDto,
  ) {
